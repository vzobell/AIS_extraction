...
idir =  'F:\MarineCadastre\matFilesMarCad';
...
odir0 = 'F:\MarineCadastre\Monthly4500mTrackAboutCPA_KF';
if ~isfolder(odir0)
    mkdir(odir0)
end
...
%             end
            ...
            save(offn3,'sdB','specTime','specFreq','thisShipTrack','rangeInterp','-v7.3');
%             
%             if shipTracks(s).MMSI == 366979960
%                 1;
%             end
            %             if size(tp,1) > 1
            %                 ofroot = ofroot0;
